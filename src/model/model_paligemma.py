      ...
      for dirpath, dirnames, filenames in os.walk(path_to_data):
        ...
        for file in filenames:
          if file.endswith(".png"):
            ...
            inputs = self.processor_1(images = image, text=prompt,
...
if __name__=="__main__":
  ...
  model_id_image = "google/paligemma2-10b-ft-docci-448"
  processor_1 = PaliGemmaProcessor.from_pretrained(model_id_image)
  model_1 = PaliGemmaForConditionalGeneration.from_pretrained(model_id_image,
                                                        low_cpu_mem_usage=True,)
